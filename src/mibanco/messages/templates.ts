/**
 * Mibanco Error Templates
 * Corresponds to yape-wall-e-qa-mbrk/data/response_templates/mibanco/templates.rb
...
export const MESSAGES_400: Record<string, ErrorTemplate> = {
  offer: {
    type: 'bff-creditosyape-azure-lead/sales/customer-offer/v1/lead',
    detail: 'Bad Request',
    instance: 'lead.consultar',
  },
  paydate: {
    type: 'creditos-yape/servicing/servicing-order/v1/simulacion/obtener-dias-pago',
    detail: 'Bad Request - Parámetros inválidos',
    instance: 'paydate.obtener',
  },
  simulate: {
    type: 'creditos-yape/servicing/servicing-order/v1/simulacion/generar',
    detail: 'Bad Request - Parámetros inválidos o fuera de rango',
    instance: 'simulate.generar',
  },
  quote: {
    type: 'creditos-yape/servicing/servicing-order/v1/simulacion/obtener-cronograma',
    detail: 'Bad Request - Parámetros inválidos o fuera de rango',
    instance: 'quote.obtener',
  },
  register: {
    type: 'creditos-yape/sales/customer-offer/v1/lead/registro',
    detail: 'Bad Request - Parámetros inválidos o fuera de rango',
    instance: 'register.crear',
  },
};
...
export const MESSAGES_401: Record<string, ErrorTemplate> = {
  offer: {
    type: 'creditos-yape/sales/customer-offer/v1/lead/consultar',
    detail: 'Unauthorized',
    instance: 'lead.consultar',
  },
  paydate: {
...
export const MESSAGES_404: Record<string, ErrorTemplate> = {
  ...
  paydate: {
    type: 'creditos-yape/servicing/servicing-order/v1',
    detail: 'Operation Not Found',
  ...
  register: {
    type: 'creditos-yape/loans-deposits/consumer-loan/v1/desembolso',
    detail: 'Operation Not Found',
