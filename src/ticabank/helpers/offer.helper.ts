...
import {
  ...
  LeadSoldException,
  TicabankException,
} from '../exceptions/ticabank-exception.js';
...
export async function getOffer(
  ...
  try {
    ...
    if (user && user.personalities) {
      ...
      if (errorPersonality) {
        const httpStatus = getHttpStatusForPersonality(errorPersonality as TicabankPersonality);
...
function evaluatePersonality(
  personalityCode: TicabankPersonality,
...
function throwExceptionForPersonality(
  ...
  const exceptionMap: Partial<Record<TicabankPersonality, new (message: string, errorBody: ErrorBody) => TicabankException>> = {
    [TicabankPersonality.OFFER_NO_DATA]: OfferNoDataException,
    [TicabankPersonality.OFFER_CALL_FAILED]: OfferCallFailedException,
    [TicabankPersonality.OFFER_CALL_TIMEOUT]: OfferTimeoutException,
    [TicabankPersonality.TICABANK_BAD_REQUEST]: BadRequestException,
    [TicabankPersonality.TICABANK_UNAUTHORIZED]: UnauthorizedException,
    [TicabankPersonality.METHOD_NOT_ALLOWED]: MethodNotAllowedException,
    [TicabankPersonality.LOAN_MANY_REQUESTS]: TooManyRequestsException,
    [TicabankPersonality.TICABANK_SERVER_ERROR]: ServerErrorException,
    [TicabankPersonality.TICABANK_NOT_CONFIRMED]: NotConfirmedException,
    [TicabankPersonality.TICABANK_INVALID_TERM]: InvalidTermException,
    [TicabankPersonality.TICABANK_PRODUCT_REGISTER]: ProductRegisteredException,
    [TicabankPersonality.TICABANK_UNABLE_LEAD]: UnableLeadException,
    [TicabankPersonality.TICABANK_LEAD_SOLD]: LeadSoldException,
  };
