...
export function isKnownPersonality(personality: string): boolean {
  return Object.values(TicabankPersonality).includes(personality as TicabankPersonality);
}
 ...
 */
export function getHttpStatusForPersonality(personality: TicabankPersonality): number | null {
 ...
 */
export function getVariantForPersonality(personality: TicabankPersonality): ErrorVariant | null {
...
export function isErrorPersonality(apiType: string, personality: string): boolean {
  ...
  const personalityEnum = personality as TicabankPersonality;
...
export function getPersonalityErrorCode(apiType: string, personality: string): number {
  const personalityCode = personality as TicabankPersonality;
