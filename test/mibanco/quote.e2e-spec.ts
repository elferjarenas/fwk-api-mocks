...
/**
 * E2E Tests for Mibanco Quote API
 * Endpoint: GET /creditos-yape/servicing/servicing-order/v1/simulacion/obtener-cronograma
 */

describe('Mibanco Quote API (e2e)', () => {
  const BASE_URL = TEST_CONFIG.baseUrl;
  const USER_IDC = '12345678';
  const QUOTE_ENDPOINT = '/creditos-yape/servicing/servicing-order/v1/simulacion/obtener-cronograma';
