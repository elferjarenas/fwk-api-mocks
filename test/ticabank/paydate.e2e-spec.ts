...
/**
 * E2E Tests for Ticabank Paydate API
 * Endpoint: GET /creditos-ticabank/servicing/servicing-order/v1/simulacion/obtener-dias-pago
 */

describe('Ticabank Paydate API (e2e)', () => {
  const BASE_URL = TEST_CONFIG.baseUrl;
  const PAYDATE_ENDPOINT = '/creditos-ticabank/servicing/servicing-order/v1/simulacion/obtener-dias-pago';
