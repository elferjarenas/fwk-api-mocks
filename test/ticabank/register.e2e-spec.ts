...
/**
 * E2E Tests for Ticabank Register API
 * Endpoint: POST /creditos-ticabank/loans-deposits/consumer-loan/v1/desembolso/generar
 */

const REGISTER_ENDPOINT = '/creditos-ticabank/loans-deposits/consumer-loan/v1/desembolso/generar';

describe('Ticabank Register API (e2e)', () => {
