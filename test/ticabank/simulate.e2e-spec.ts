...
/**
 * E2E Tests for Ticabank Simulate API
 * Endpoint: GET /creditos-ticabank/servicing/servicing-order/v1/simulacion/generar
 */

const SIMULATE_ENDPOINT = '/creditos-ticabank/servicing/servicing-order/v1/simulacion/generar';

describe('Ticabank Simulate API (e2e)', () => {
